...
interface IAirdropDistributor {
    ...
    event VeCypherNftClaimed(address indexed claimant, uint256 value, uint256 indexed rootId, bytes32 indexed root);
    // --- Errors ---
    ...
    function claim(bytes32[] calldata proof, uint256 rootId, uint256 tokenAirdropValue, uint256 nftTokenValue)
        external;
    // --- Views ---
